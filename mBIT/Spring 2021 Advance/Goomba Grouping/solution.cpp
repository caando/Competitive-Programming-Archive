...
void solve(){
	...
	if (n < 5) cout << -1 << endl;
		...
		cout << k + 3 << ' ' << k + 4 << ' ' << k + 5 << ' ';
		if (n&1){
			cout << (ll)100000000000 + 2 << ' ' << (ll)100000000000 << ' ';
			forn(i, 0, n-5) cout << (ll)100000000000 << ' ';
		} else {
			cout << 100000000000 + 2 << ' ' << 100000000000/2 << ' ' << 100000000000/2 << ' ';
			forn(i, 0, n-6) cout << (ll)100000000000 << ' ';
		}
	}
	cout << endl;
}
